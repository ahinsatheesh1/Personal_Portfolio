    ...
    <>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-16 -mt-8">
        ...
        <div className="relative rounded-2xl p-[1px] bg-gradient-to-r from-white/10 to-white/5 mb-10">
          <div className="rounded-2xl bg-white/5 backdrop-blur p-6 md:p-8">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-100">Data Science & Machine Learning Intern</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="inline-flex px-2 py-0.5 rounded-full text-xs bg-emerald-500/10 text-emerald-300 border border-emerald-500/20">Hybrid</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <FiUser className="text-purple-400 mt-0.5" />
                    <div>
                      <div className="text-xs uppercase tracking-wide text-gray-400">Mentor</div>
                      <div className="text-gray-100">Rajeev Azhuvath</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-100">School of Engineering, CUSAT</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="md:col-span-3 md:flex md:justify-end">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow hover:opacity-95"
                >
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          {/* Overview */}
          <section className="rounded-xl border border-white/10 bg-white/5 p-6 md:p-7">
            <div className="flex items-center gap-2 mb-2">
              <FiGrid className="text-blue-400" />
              <h3 className="text-xl md:text-2xl font-extrabold leading-tight tracking-tight">
                <span className="bg-gradient-to-r from-blue-500 to-blue-300 bg-clip-text text-transparent">Overview</span>
              </h3>
            </div>
            <div className="h-1 w-20 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 mb-3" />
          ...
          <section className="rounded-xl border border-white/10 bg-white/5 p-6 md:p-7">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-xl md:text-2xl font-extrabold leading-tight tracking-tight">
                <span className="bg-gradient-to-r from-blue-500 to-blue-300 bg-clip-text text-transparent">Key Responsibilities</span>
              </h3>
            </div>
            <div className="h-1 w-20 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 mb-3" />
          ...
          <section className="rounded-xl border border-white/10 bg-white/5 p-6 md:p-7">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-xl md:text-2xl font-extrabold leading-tight tracking-tight">
                <span className="bg-gradient-to-r from-blue-500 to-blue-300 bg-clip-text text-transparent">Tools & Technologies</span>
              </h3>
            </div>
            <div className="h-1 w-20 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 mb-3" />
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-300 text-sm">
              ...
              <div className="space-y-1">
                <div className="text-gray-400">Version Control</div>
                <div>Git & GitHub</div>
              </div>
            </div>
          </section>
          ...
          <section className="rounded-xl border border-white/10 bg-white/5 p-6 md:p-7">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-xl md:text-2xl font-extrabold leading-tight tracking-tight">
                <span className="bg-gradient-to-r from-blue-500 to-blue-300 bg-clip-text text-transparent">Outcome</span>
              </h3>
            </div>
            <div className="h-1 w-20 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 mb-3" />
            <p className="text-gray-300">
